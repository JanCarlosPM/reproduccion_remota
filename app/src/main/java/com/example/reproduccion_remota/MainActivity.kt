package com.example.reproduccion_remota
...
import com.example.reproduccion_remota.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imagen.setImageURI(Uri.parse("android.resource://" + packageName + "/"))

        urltext.visibility = View.INVISIBLE
        contenedor.visibility = View.INVISIBLE
        buscarvideo.setOnClickListener() {
            startActivity(Intent(this,  BuscarArchivo()::class.java))
        }
        ...
        imagen.setOnClickListener {
            if (contador == 0) {
                ...
                Handler().postDelayed(
                    {
                        Toast.makeText(
                            this, "Ahora pon una URL para buscar una imagen", Toast.LENGTH_SHORT
                        ).show()
                    }, 4000
                ) // 4 segundos
            } else {
