...
import com.example.reproduccion_remota.databinding.ActivityBuscarArchivoBinding

class BuscarArchivo : AppCompatActivity() {

    private lateinit var archivos: ActivityBuscarArchivoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        archivos = ActivityBuscarArchivoBinding.inflate(layoutInflater)
